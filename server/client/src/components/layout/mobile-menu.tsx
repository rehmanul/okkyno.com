    ...
    <div className="fixed inset-0 z-50 lg:hidden overflow-hidden" aria-modal="true" role="dialog">
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
          ...
          >
            <X role="img" aria-label="Close icon" size={20} />
          </button>
        </div>
                  ...
                  <>
                    ...
                    >
                      ...
                      {openSubmenus[category.name] ? (
                        <ChevronUp role="img" aria-label="Collapse submenu" size={18} className="text-gray-500" />
                      ) : (
                        <ChevronDown role="img" aria-label="Expand submenu" size={18} className="text-gray-500" />
                      )}
                    </button>
