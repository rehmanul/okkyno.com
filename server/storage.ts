    ...
    const products: InsertProduct[] = [
      {
        ...
        description: "Professional stainless steel garden pruners with ergonomic handles for clean cuts and comfortable use. Perfect for trimming and shaping plants.",
      ...
      },
      {
        ...
        description: "3-piece ergonomic gardening tools with comfort grip handles. Includes a trowel, transplanter, and weeder for all your garden needs.",
      ...
      },
      {
        ...
        description: "Complete starter kit with seeds, soil, and containers for growing your own culinary herbs at home. Includes basil, parsley, and mint.",
      ...
      },
      {
        ...
        description: "10-pattern spray nozzle for all watering needs. Features comfortable grip, adjustable flow control, and durable metal construction.",
