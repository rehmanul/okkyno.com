    ...
    <footer className="bg-dark text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-heading font-bold mb-4">Okkyno</h3>
          ...
          <div>
            <h3 className="text-xl font-heading font-bold mb-4">Categories</h3>
            <ul className="space-y-2">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href={`tel:${companyInfo.phone}`} className="text-gray-400 hover:text-white transition">
                  {companyInfo.phone}
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href={`mailto:${companyInfo.email}`} className="text-gray-400 hover:text-white transition">
                  {companyInfo.email}
                </a>
              </li>
              <li className="flex items-center">
