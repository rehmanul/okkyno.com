        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="grid grid-cols-5">
              ...
              <div className="col-span-3 p-6 flex flex-col justify-center">
                <h3 className="text-2xl font-heading font-bold mb-3">Indoor Plant Collection</h3>
                <p className="text-gray-600 mb-4">Perfect for beginners. Low-maintenance plants that thrive indoors.</p>
                <Link href="/products/category/indoor-plants">
                  <Button className="bg-primary hover:bg-primary/90 text-white font-semibold self-start">
                    Shop Now
                  </Button>
                </Link>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="grid grid-cols-5">
              ...
              <div className="col-span-3 p-6 flex flex-col justify-center">
                <h3 className="text-2xl font-heading font-bold mb-3">Essential Garden Tools</h3>
